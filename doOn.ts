...
export async function doOn(cc: CamelConfig, downlinks: DownLink[]){
    ...
    for(const onString of On!){
        const onPassStatement = tryParse(onString, reOnPassDownstreamStatement) as OnPassStatement | null;
